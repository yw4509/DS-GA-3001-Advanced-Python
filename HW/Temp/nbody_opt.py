...
def report_energy(BODIES,loops, iterations,dt,e=0.0):
    '''
    ...
    for _ in range(loops):
        ...
        'Put advance iterations inside the report energy to further speed up the time'
        for _ in range(iterations):
            for body1, body2 in list(combinations(BODIES.keys(), 2)):
                ([x1, y1, z1], v1, m1) = BODIES[body1]
                ([x2, y2, z2], v2, m2) = BODIES[body2]
...
def nbody(loops, reference, iterations):
    ...
    report_energy(BODIES,loops, iterations, 0.01, e=0.0)
